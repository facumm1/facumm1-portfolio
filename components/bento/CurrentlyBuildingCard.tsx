  ...
  return (
    <SpotlightCard className="col-span-12 md:col-span-5 flex flex-col justify-between p-6">
      <div className="flex items-center justify-between">
        <span className="text-xs font-medium text-muted uppercase tracking-wider">Currently building</span>
      ...
      <div className="mt-4">
        ...
        <p className="mt-1.5 text-sm text-muted leading-relaxed">{currentlyBuilding.description}</p>
      </div>

      <div className="mt-4">
        <p className="mb-3 text-xs text-muted/70">{currentlyBuilding.status}</p>
